    ...
    return (
        <li className="flex items-center py-3">
            <div className="flex-grow">
                ...
                <p className="text-sm text-on-surface-variant">{transaction.date} • {transaction.bankName}</p>
            </div>
        ...
        <div className="lg:col-span-3">
          <Card className="p-6">
            <div className="flex justify-between items-center mb-4">
                ...
                <Button onClick={onConnectAnother} variant="outlined">Connect Another Account</Button>
            </div>
