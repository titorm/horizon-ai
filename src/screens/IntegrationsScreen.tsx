...
const IntegrationCard: React.FC<{ integration: Integration }> = ({ integration }) => {
    ...
    return (
        <Card className="p-4 flex items-center gap-4 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
            ...
            {connected ? (
                <Button variant="outlined" disabled leftIcon={<CheckIcon className="w-4 h-4" />}>Connected</Button>
            ) : (
    ...
    return (
        <div className="p-4 md:p-8">
            <header className="mb-8">
                ...
                <p className="text-base text-on-surface-variant">Connect other services to enrich your financial picture and automate tracking.</p>
            </header>
