...
const getPolicyIcon = (type: InsurancePolicy['type']) => {
    switch(type) {
        case 'Life': return <ShieldIcon className="w-8 h-8 text-on-primary-container" />;
        case 'Home': return <HomeIcon className="w-8 h-8 text-on-primary-container" />;
        case 'Auto': return <CarIcon className="w-8 h-8 text-on-primary-container" />;
        default: return <ShieldIcon className="w-8 h-8 text-on-primary-container" />;
    }
}
        ...
        <div className="p-4 md:p-8">
            <header className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-base text-on-surface-variant">Manage your insurance coverage for peace of mind.</p>
                </div>
